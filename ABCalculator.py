...
def do_processing():
    ...
    if n1<=0 or n2<=0:
        mb.showerror(title="Ошибка", message="Неверное количество посетителелй")
        return
...
def popup_window(n1, c1, n2, c2):
    ...
    # Добавл вывода конверсии и стандартного отклонения
    p1 = c1/n1
    p2 = c2/n2
    ...
    if confidence_95:
        lblResult95 = tk.Label(window, text = "ДА", font = ('Harlow Solid Italic', 12, 'bold'), fg = '#00cc00')
        lblResult95.place(x=160, y=25)
    else:
        lblResult95 = tk.Label(window, text = "НЕТ", font = ('Harlow Solid Italic', 12, 'bold'), fg = '#ff0000')
        lblResult95.place(x=160, y=25)
    ...
    if confidence_99:
        lblResult99 = tk.Label(window, text = "ДА", font = ('Harlow Solid Italic', 12, 'bold'), fg = '#00cc00')
        lblResult99.place(x=160, y=65)
    else:
        lblResult99 = tk.Label(window, text = "НЕТ", font = ('Harlow Solid Italic', 12, 'bold'), fg = '#ff0000')
        lblResult99.place(x=160, y=65)
